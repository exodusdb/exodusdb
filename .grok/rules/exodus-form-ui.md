...
3. **`[NUMBER…]` / `[DECIMAL…]`:** `service/www/exodus/doc/FORM-UI-NUMBER.md`.
3. **Narrow vs extreme-wide (AIM + method):** `service/www/exodus/doc/FORM-UI-WIDE-NARROW.md` — free-text fold under soft ceiling; **no** nest `width:max-content`; **30ch only** with `.exodusform-wide`.
