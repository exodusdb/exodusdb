...
//	assert(var("abc/:cde").b(1, ":/", pos)  eq "abc");
	...
	//STDDEV
	////////
	assert(stddev("-11.2^0^11.5^12^13.9^14"_var).errputl("stddev:") eq "6^40.2^-11.2^14^6.7^9.32344714506"_var);
	...
	{
		let v1 = "1]2^3]4^5]6"_var;
		assert(v1.mv("*","3]4^5]6"_var).logputl() == "3]8^15]24^0]0"_var);
	}
