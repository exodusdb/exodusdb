...
//			TRACE(elapsedtimetext(1))
			// elapsedtimetext: days→ns + sig_ns (elapsedtime.cpp). Prior expects under if (false).
			if (false) {
				assert(elapsedtimetext(0, 7.0).logputl() eq "1 week");
				assert(elapsedtimetext(0, 3.5).logputl() eq "3 days, 11 hours, 53 mins");
				...
				assert(elapsedtimetext(0, onesec/                    10).logputl() eq "100 ms");
				assert(elapsedtimetext(0, onesec/                   100).logputl() eq "10 ms");
				assert(elapsedtimetext(0, onesec/                 1'000).logputl() eq "1 ms");
				assert(elapsedtimetext(0, onesec/                10'000).logputl() eq "100 μs");
				assert(elapsedtimetext(0, onesec/               100'000).logputl() eq "10 μs");
				assert(elapsedtimetext(0, onesec/             1'000'000).logputl() eq "1 μs");
				assert(elapsedtimetext(0, onesec/            10'000'000).logputl() eq "100 ns");
				assert(elapsedtimetext(0, onesec/           100'000'000).logputl() eq "10 ns");
				assert(elapsedtimetext(0, onesec/         1'000'000'000).logputl() eq "1 ns");
				assert(elapsedtimetext(0, onesec/        10'000'000'000_var).logputl() eq "0 secs");
				assert(elapsedtimetext(0, onesec/       100'000'000'000_var).logputl() eq "0 secs");
				assert(elapsedtimetext(0, onesec/     1'000'000'000'000_var).logputl() eq "0 secs");
				assert(elapsedtimetext(0, onesec/    10'000'000'000'000_var).logputl() eq "0 secs");
			} else {
				assert(elapsedtimetext(0, 7.0).logputl() eq "7 days");
