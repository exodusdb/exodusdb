...
//#endif
		...
		*/
		...
		assert(test2("00000000000000000000.00000000000000000001",                   "9.999999999999999e-21x"));
#endif
		...
		assert(test2("00000000000000000000.00000000123456789012",                   "1.23456789012e-09x"));
		...
		assert(test2("00000000000000000000.0000000012345678901234567",              "1.2345678901234566e-09x"));
		...
		assert(test2("00000000000000000000.000000000000000000012345678901234567",   "1.234567890123457e-20x"));
		assert(test2("00000000000000000000.00000000000000000012345678901234567",    "1.234567890123457e-19x"));
		assert(test2("00000000000000000000.0000000000000000012345678901234567",     "1.234567890123457e-18x"));
		assert(test2("00000000000000000000.000000000000000012345678901234567",      "1.234567890123457e-17x"));
		assert(test2("00000000000000000000.00000000000000012345678901234567",       "1.234567890123457e-16x"));
		assert(test2("00000000000000000000.0000000000000012345678901234567",        "1.234567890123457e-15x"));
		assert(test2("00000000000000000000.000000000000012345678901234567",         "1.234567890123457e-14x"));
		assert(test2("00000000000000000000.00000000000012345678901234567",          "1.234567890123457e-13x"));
		assert(test2("00000000000000000000.0000000000012345678901234567",           "1.234567890123457e-12x"));
		assert(test2("00000000000000000000.000000000012345678901234567",            "1.234567890123457e-11x"));
		assert(test2("00000000000000000000.00000000012345678901234567",             "1.234567890123457e-10x"));
		assert(test2("00000000000000000000.0000000012345678901234567",              "1.234567890123457e-09x"));
		assert(test2("00000000000000000000.000000012345678901234567",               "1.234567890123457e-08x"));
		assert(test2("00000000000000000000.00000012345678901234567",                "1.234567890123457e-07x"));
		...
		assert(test2("00000012345678901234.56789010000000000000",      "1.234567890123457e+13x"));
		assert(test2("00000123456789012345.67890100000000000000",     "1.234567890123457e+14x"));
		assert(test2("00001234567890123456.78901000000000000000",    "1.234567890123457e+15x"));
		assert(test2("00012345678901234567.89010000000000000000",   "1.234567890123457e+16x"));
		assert(test2("00123456789012345678.90100000000000000000",  "1.234567890123457e+17x"));
		assert(test2("01234567890123456789.01000000000000000000", "1.234567890123457e+18x"));
		assert(test2("12345678901234567890.10000000000000000000","1.234567890123457e+19x"));
#endif
	}
