...
////////////////
	...
	printl("oconv_TX(const char* conversion) const;");
	{
		...
		// 5. VM -> "\" \n
		let v5 = "v1]v2"_var.oconv("TX"); assert(v5.errputl() == "v1" B_S _NL "v2");
		// 6. SM -> "\\" \n
		let v6 = "s1}s2"_var.oconv("TX"); assert(v6.errputl() == "s1" B_S B_S _NL "s2");
		// 7. TM -> "\\\" \n
		let v7 = "t1|t2"_var.oconv("TX"); assert(v7.errputl() == "t1" B_S B_S B_S _NL "t2");
		// 8. STM -> "\\\\" \n
		let v8 = "st1~st2"_var.oconv("TX"); assert(v8.errputl() == "st1" B_S B_S B_S B_S _NL "st2");
	}
