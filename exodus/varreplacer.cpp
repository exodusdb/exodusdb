...
IO   var_mid::updater(int fieldno, int valueno, int subvalueno, in replacement) REF {

	THISIS("void var_mid::updater(int fieldno, int valueno, int subvalueno, in replacement) &")
