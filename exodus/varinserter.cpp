...
IO   var_mid::inserter(const int fieldno, const int valueno, const int subvalueno, in insertion) REF {

	THISIS("void var_mid::inserter(const int fieldno, const int valueno, const int subvalueno, in insertion) &")
