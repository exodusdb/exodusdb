...
//                https://x.com/i/grok/share/M783PnlF9t7yr7krrjo54xm7V
                ::operator delete[](_Ptr);  // Change to this (remove the size argument)
            };
...
// work around error C2825: '_Alloc': must be a class or namespace when followed by '::'
