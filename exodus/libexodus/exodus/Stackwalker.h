...
class StackWalker {
   public:
	...
	BOOL ShowCallstack(HANDLE hThread = GetCurrentThread(), const CONTEXT* context = nullptr, PReadProcessMemoryRoutine readMemoryFunction = nullptr,
	...
	// in older compilers in order to use it... starting with VC7 we can declare it as
	// "protected"
   protected:
#endif
	enum {
