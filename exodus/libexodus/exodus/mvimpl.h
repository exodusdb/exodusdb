...
class pimpl
{
	...
	*/
	...
	/* moved to var private	//data members
		//all mutable because asking for a string can create it from an integer and vice
	   versa mutable std::wstring mvstr; mutable wchar_t mvtype; mutable int mvint; mutable
	   double mvdbl;
	*/
};
