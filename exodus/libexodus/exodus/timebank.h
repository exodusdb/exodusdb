...
auto get_timeacno(const std::string_view arg1) -> int {
	...
	*/
	...
	else if ((arg1 == "var dim::split(CVR str1, SV sepchar = FM)")) acno = 2;
	else if ((arg1 == "bool dim::read(CVR filevar, CVR key)")) acno = 3;
	else if ((arg1 == "bool dim::write(CVR filevar, CVR key) const")) acno = 4;
	else if ((arg1 == "bool dim::osread(CVR osfilename, const char* codepage DEFAULT_EMPTY)")) acno = 5;
	else if ((arg1 == "bool dim::oswrite(CVR osfilename, const char* codepage DEFAULT_EMPTY)")) acno = 6;
	else if ((arg1 == "var var::sort(SV sepchar = FM)")) acno = 7;
	else if ((arg1 == "var var::reverse(SV sepchar = FM)")) acno = 8;
	else if ((arg1 == "var var::timestamp(CVR ostime) const")) acno = 9;
	else if ((arg1 == "bool var::connect(CVR conninfo")) acno = 10;
	else if ((arg1 == "bool var::attach(CVR filenames")) acno = 11;
	else if ((arg1 == "bool var::detach(CVR filenames")) acno = 12;
	else if ((arg1 == "bool var::disconnect()")) acno = 13;
	else if ((arg1 == "bool var::disconnectall()")) acno = 14;
	else if ((arg1 == "bool var::open(CVR filename, CVR connection)")) acno = 15;
	else if ((arg1 == "bool var::open cache_miss")) acno = 16;
	else if ((arg1 == "void var::close()")) acno = 17;
	else if ((arg1 == "bool var::readc(CVR filehandle,CVR key)")) acno = 18;
	else if ((arg1 == "void var::writec(CVR filehandle,CVR key)")) acno = 19;
	else if ((arg1 == "bool var::deletec(CVR key)")) acno = 20;
	else if ((arg1 == "bool var::read(CVR filehandle,CVR key)")) acno = 21;
	else if ((arg1 == "bool var::reado cache_miss")) acno = 22;
	else if ((arg1 == "var var::hash() const")) acno = 23;
	else if ((arg1 == "var var::lock(CVR key) const")) acno = 24;
	else if ((arg1 == "void var::unlock(CVR key) const")) acno = 25;
	else if ((arg1 == "void var::unlockall() const")) acno = 26;
	else if ((arg1 == "bool var::sqlexec(CVR sqlcmd, VARREF response) const")) acno = 27;
	else if ((arg1 == "bool var::writef(CVR filehandle,CVR key,const int fieldno) const")) acno = 28;
	else if ((arg1 == "bool var::write(CVR filehandle, CVR key) const")) acno = 29;
	else if ((arg1 == "bool var::updaterecord(CVR filehandle,CVR key) const")) acno = 30;
	else if ((arg1 == "bool var::insertrecord(CVR filehandle,CVR key) const")) acno = 31;
	else if ((arg1 == "bool var::deleterecord(CVR key) const")) acno = 32;
	...
	else if ((arg1 == "bool var::dbcreate(CVR from_dbname, CVR to_dbname)")) acno = 38;
	else if ((arg1 == "bool var::dbdelete(CVR dbname)")) acno = 39;
	else if ((arg1 == "bool var::createfile(CVR filename)")) acno = 40;
	else if ((arg1 == "bool var::renamefile(CVR filename, CVR newfilename)")) acno = 41;
	else if ((arg1 == "bool var::deletefile(CVR filename)")) acno = 42;
	else if ((arg1 == "bool var::clearfile(CVR filename)")) acno = 43;
	else if ((arg1 == "bool var::select(CVR sortselectclause) const")) acno = 44;
	else if ((arg1 == "bool var::deletelist(CVR listname) const")) acno = 45;
	else if ((arg1 == "bool var::savelist(CVR listname)")) acno = 46;
	else if ((arg1 == "bool var::getlist(CVR listname) const")) acno = 47;
	else if ((arg1 == "bool var::formlist(CVR keys, CVR fieldno)")) acno = 48;
	else if ((arg1 == "bool var::makelist(CVR listname)")) acno = 49;
	...
	else if ((arg1 == "bool var::createindex(CVR fieldname, CVR dictfile) const")) acno = 53;
	else if ((arg1 == "bool var::deleteindex(CVR fieldname) const")) acno = 54;
	...
	else if ((arg1 == "var var::listindex(CVR filename) const")) acno = 58;
	else if ((arg1 == "var var::reccount(CVR filename_or_handle_or_null) const")) acno = 59;
	else if ((arg1 == "var var::flushindex(CVR filename=) const")) acno = 60;
	else if ((arg1 == "bool var::input()")) acno = 61;
	else if ((arg1 == "bool var::input(CVR prompt")) acno = 62;
	else if ((arg1 == "bool var::inputn(const int nchars")) acno = 63;
	else if ((arg1 == "VARREF var::default_to(CVR defaultvalue) const")) acno = 64;
	else if ((arg1 == "VARREF var::default_from(CVR defaultvalue)")) acno = 65;
	...
	else if ((arg1 == "VARREF var::converter(CVR fromchars,CVR tochars)")) acno = 101;
	...
	else if ((arg1 == "var var::xlate(CVR filename,CVR fieldno, const char* mode) const")) acno = 108;
	...
	else if ((arg1 == "var var::mod(CVR limit) const")) acno = 112;
	...
	else if ((arg1 == "var var::pwr(CVR exponent) const")) acno = 122;
	...
	else if ((arg1 == "var var::osshellwrite(CVR oscmd) const")) acno = 126;
	else if ((arg1 == "bool var::osopen(CVR osfilename, const char* locale)")) acno = 127;
	else if ((arg1 == "bool var::osopenx(CVR osfilename, const char* locale)")) acno = 128;
	...
	else if ((arg1 == "bool var::oswrite(CVR osfilename, const char* codepage) const")) acno = 132;
	else if ((arg1 == "bool var::osbwrite(CVR osfilevar, VARREF offset) const")) acno = 133;
	else if ((arg1 == "bool var::osbread(CVR osfilevar, VARREF offset, const int bytesize")) acno = 134;
	else if ((arg1 == "bool var::osrename(CVR new_dirpath_or_filepath) const")) acno = 135;
	else if ((arg1 == "bool var::oscopy(CVR new_dirpath_or_filepath) const")) acno = 136;
	else if ((arg1 == "bool var::osmove(CVR new_dirpath_or_filepath) const")) acno = 137;
	else if ((arg1 == "bool var::osrmdir(bool evenifnotempty) const")) acno = 138;
	else if ((arg1 == "var var::oslist(CVR globpattern, const int mode) const")) acno = 139;
	...
	else if ((arg1 == "VARREF var::fieldstorer(SV separator0,const int fieldnx,const int nfieldsx, CVR replacementx)")) acno = 152;
	else if ((arg1 == "bool var::locate(CVR target, VARREF setting, const int fieldno/*=0*/,const int valueno/*=0*/) const")) acno = 153;
	else if ((arg1 == "bool var::locate(CVR target, VARREF setting, const int fieldno/*=0*/,const int valueno/*=0*/) const")) acno = 154;
	else if ((arg1 == "bool var::locate(CVR target) const")) acno = 155;
	else if ((arg1 == "bool var::locateby(const char* ordercode, CVR target, VARREF setting) const")) acno = 156;
	else if ((arg1 == "bool var::locateby(const char* ordercode, CVR target, VARREF setting, const int fieldno, const int valueno/*=0*/) const")) acno = 157;
	else if ((arg1 == "bool var::locatebyusing(const char* ordercode, const char* usingchar, CVR target, VARREF setting, const int fieldno=0, const int valueno=0, const int valueno=0) const")) acno = 158;
	else if ((arg1 == "bool var::locateusing(const char* usingchar, CVR target) const")) acno = 159;
	else if ((arg1 == "bool var::locateusing(const char* usingchar, CVR target, VARREF setting, const int fieldno/*=0*/, const int valueno/*=0*/, const int subvalueno/*=0*/) const")) acno = 160;
	...
	else if ((arg1 == "VARREF var::r(int fieldno,int valueno,int subvalueno,CVR replacement)")) acno = 163;
	...
	else if ((arg1 == "var var::multivalued(const char* opcode, CVR var2) const")) acno = 176;
	...
	else if ((arg1 == "CVR var::swap(CVR var2) const")) acno = 186;
