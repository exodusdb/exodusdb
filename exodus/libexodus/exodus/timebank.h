...
auto get_timeacno(const std::string_view arg1) -> int {
	...
	*/
	...
	else if ((arg1 == "bool var::sqlexec(in sqlcmd, io response) const")) acno = 27;
	...
	else if ((arg1 == "bool var::readnext(io key, io valueno) const")) acno = 51;
	else if ((arg1 == "bool var::readnext(io record, io key, io valueno) const")) acno = 52;
	...
	else if ((arg1 == "io   var::trim(SV trimchars)")) acno = 72;
	else if ((arg1 == "io   var::trimmer(SV trimchars)")) acno = 73;
	else if ((arg1 == "io   var::trimfirst(SV trimchars) const&")) acno = 74;
	else if ((arg1 == "io   var::trimmerfirst(SV trimchars)")) acno = 75;
	else if ((arg1 == "io   var::trimlast(SV trimchars) const&")) acno = 76;
	else if ((arg1 == "io   var::trimmerlast(SV trimchars)")) acno = 77;
	else if ((arg1 == "io   var::trimboth(SV trimchars) const&")) acno = 78;
	else if ((arg1 == "io   var::trimmerboth(SV trimchars)")) acno = 79;
	else if ((arg1 == "io   var::inverter()")) acno = 80;
	else if ((arg1 == "io   var::ucaser()")) acno = 81;
	else if ((arg1 == "io   var::lcaser()")) acno = 82;
	else if ((arg1 == "io   var::tcaser()")) acno = 83;
	else if ((arg1 == "io   var::fcaser()")) acno = 84;
	else if ((arg1 == "io   var::normalizer()")) acno = 85;
	else if ((arg1 == "var  var::unique()")) acno = 86;
	else if ((arg1 == "var  var::seq() const")) acno = 87;
	else if ((arg1 == "var  var::textseq() const")) acno = 88;
	else if ((arg1 == "io   var::paster(const int pos1, const int length, SV insertstr)")) acno = 89;
	else if ((arg1 == "io   var::paster(const int pos1, SV insertstr)")) acno = 90;
	else if ((arg1 == "var  var::prefix(SV insertstr)")) acno = 91;
	else if ((arg1 == "io   var::prefixer(SV insertstr)")) acno = 92;
	else if ((arg1 == "io   var::popper()")) acno = 93;
	else if ((arg1 == "io   var::move(io tovar)")) acno = 94;
	else if ((arg1 == "var  var::str(const int num) const")) acno = 95;
	else if ((arg1 == "var  var::space() const")) acno = 96;
	else if ((arg1 == "io   var::cropper()")) acno = 97;
	else if ((arg1 == "io   var::lowerer()")) acno = 98;
	else if ((arg1 == "io   var::raiser()")) acno = 99;
	else if ((arg1 == "io   var::converter(SV fromchars, SV tochars)")) acno = 100;
	else if ((arg1 == "io   var::converter(in fromchars, in tochars)")) acno = 101;
	else if ((arg1 == "io   var::parser(char sepchar)")) acno = 102;
	...
	else if ((arg1 == "bool var::osbwrite(in osfilevar, io offset) const")) acno = 133;
	else if ((arg1 == "bool var::osbread(in osfilevar, io offset, const int bytesize")) acno = 134;
	...
	else if ((arg1 == "io   var::fieldstorer(SV separator0, const int fieldnx, const int nfieldsx, in replacementx)")) acno = 152;
	else if ((arg1 == "bool var::locate(in target, io setting, const int fieldno/*=0*/, const int valueno/*=0*/) const")) acno = 153;
	else if ((arg1 == "bool var::locate(in target, io setting, const int fieldno/*=0*/, const int valueno/*=0*/) const")) acno = 154;
	else if ((arg1 == "bool var::locate(in target) const")) acno = 155;
	else if ((arg1 == "bool var::locateby(const char* ordercode, in target, io setting) const")) acno = 156;
	else if ((arg1 == "bool var::locateby(const char* ordercode, in target, io setting, const int fieldno, const int valueno/*=0*/) const")) acno = 157;
	else if ((arg1 == "bool var::locatebyusing(const char* ordercode, const char* usingchar, in target, io setting, const int fieldno=0, const int valueno=0, const int valueno=0) const")) acno = 158;
	else if ((arg1 == "bool var::locateusing(const char* usingchar, in target) const")) acno = 159;
	else if ((arg1 == "bool var::locateusing(const char* usingchar, in target, io setting, const int fieldno/*=0*/, const int valueno/*=0*/, const int subvalueno/*=0*/) const")) acno = 160;
	else if ((arg1 == "var  var::f(const int argfieldn, const int argvaluen, const int argsubvaluen) const")) acno = 161;
	else if ((arg1 == "io   var::remover(int fieldno, int valueno, int subvalueno)")) acno = 162;
	else if ((arg1 == "io   var::r(int fieldno, int valueno, int subvalueno, in replacement)")) acno = 163;
	else if ((arg1 == "io   var::inserter(const int fieldno, const int valueno, const int subvalueno, in insertion)")) acno = 164;
	...
	else if ((arg1 == "io   var::firster(const std::size_t length)")) acno = 169;
	else if ((arg1 == "var  var::last(const std::size_t length) const")) acno = 170;
	else if ((arg1 == "io   var::laster(const std::size_t length)")) acno = 171;
	else if ((arg1 == "var  var::cut(const int length) const")) acno = 172;
	else if ((arg1 == "io   var::cutter(const int length)")) acno = 173;
	else if ((arg1 == "io   var::substrer(const int startindex1, const int length)")) acno = 174;
	...
	else if ((arg1 == "var  var::substr(const int startindex1, io delimiterchars, int& endindex) const")) acno = 177;
	else if ((arg1 == "var  var::substr2(io startindex1, io delimiterno) const")) acno = 178;
	...
	else if ((arg1 == "str  var::oconv_MT(const char* conversion) const")) acno = 205;
	else if ((arg1 == "var  var::iconv_HEX(const int ioratio) const")) acno = 206;
	else if ((arg1 == "var  var::iconv_TX(const char* conversion) const")) acno = 207;
