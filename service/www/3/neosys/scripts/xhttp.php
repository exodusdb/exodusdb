...
//instead of doing chmod after all file creations
//create all files with permissions 0775 so server processes can manage them
//assuming that sgid setup correctly so group user is that of the parent dir
//umask(0002);
//or full permissions in case sgid isnt setup correctly
umask(0);
...
function getdatabases($neosysrootpath, $systemcode)
{
	...
	if (!is_file($volfilename)) {
		$volfilename2 = $neosysrootpath . 'data/default.vol';
