...
function* dict_USERS() {
 ...
 var istimesheetadmin=yield* neosyssecurity('TIMESHEET ADMINISTRATION')
 var timesheetadminreadonlymsg=gmsg
 
 gusers_authorisation_update=yield* neosyssecurity('AUTHORISATION UPDATE')
 ...
 if (yield* neosyssecurity('AUTHORISATION ACCESS')) {
 ...
 */
 ...
 neosys_dict_colorfontsize(dict,19)
 din=dict.length-1
 ...
 neosys_dict_date(di,'TO=HOLIDAY_UPTO_DATE')
 ...
 di.readonly=timesheetadminreadonlymsg
 neosys_dict_date(di,'FROM=HOLIDAY_FROM_DATE')
