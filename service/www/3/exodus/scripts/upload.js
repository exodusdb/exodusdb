...
async function showuploadtable() {
 ...
 // submit can fail after automatic popup of file browse — handle carefully
 ...
 */
 ...
 // "htmlfile: Access is denied." on .submit() — mitigated by removing name on file field
 ...
 // postupload: this page and/or calling page (jobs.htm/vouchers.htm etc) depending on upload frame model
