...
check('max 0 accept neg', NUMBER('ICONV', '-1', '2,,0'), '-1.00')
...
check('ICONV strip negative group', NUMBER('ICONV', '-1,234,567.80', '2'), '-1234567.80')
...
if (!hasCurrency) {
    ...
    check('ICONV negative+unit', NUMBER('ICONV', '-1234567.5USD', '2,CURRENCY'), '-1234567.50USD')
