...
//	}
	...
	switch (msgno.toInt()) {
		...
		case 12:
			msg =
				"Somebody has updated this record.|Your update cannot be applied."
				"|The session id does not agree " ^
				(params.quote());
			return 0;
		case 13:
			msg =
				"You or somebody else has updated this record.|Your update cannot be applied."
				"|The time stamp does not agree||Perhaps it is already saved.|Open it in another window to check.";
			return 0;
		case 14:
