...
var operator() () {
 ...
 var list2_io;
 var seps_in;
 return operator()(mode_in, list1_io, list2_io, seps_in);
}
...
var operator() (in mode) {
 ...
 var list2_io;
 var seps_in;
 return operator()(mode, list1_io, list2_io, seps_in);
}

var operator() (in mode, io list1) {
 var list2_io;
 var seps_in;
 return operator()(mode, list1, list2_io, seps_in);
}

var operator() (in mode, io list1, io list2) {
 var seps_in;
 return operator()(mode, list1, list2, seps_in);
}
