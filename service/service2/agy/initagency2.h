//generated by exodus "compile initagency2"
...
var initagency2(io logtime, in reloading="")
{

 //first time link to the shared lib and create/cache an object from it
 //passing current standard variables in mv
 if (efb_initagency2.pmemberfunction_==NULL)
  efb_initagency2.init("initagency2","exodusprogrambasecreatedelete_",mv);
