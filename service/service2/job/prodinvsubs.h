//generated by exodus "compile ../job/prodinvsubs"
//#ifndef EXODUSDLFUNC_PRODINVSUBS_H
#define EXODUSDLFUNC_PRODINVSUBS_H

//a member variable/object to cache a pointer/object for the shared library function
//ExodusFunctorBase efb_prodinvsubs;
class efb_prodinvsubs : private ExodusFunctorBase
{
public:

efb_prodinvsubs(MvEnvironment& mv) : ExodusFunctorBase("prodinvsubs", "exodusprogrambasecreatedelete_", mv) {}

efb_prodinvsubs& operator=(const var& newlibraryname) {
        closelib();
...
efb_prodinvsubs prodinvsubs{mv};
//#endif
