...
var timesheetparamsubs(in mode)
{

 //first time link to the shared lib and create/cache an object from it
 //passing current standard variables in mv
 if (efb_timesheetparamsubs.pmemberfunction_==NULL)
  efb_timesheetparamsubs.init("timesheetparamsubs","exodusprogrambasecreatedelete_",mv);
