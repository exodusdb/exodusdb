//generated by exodus "compile getauthorisation"
...
var getauthorisation()
{

 //first time link to the shared lib and create/cache an object from it
 //passing current standard variables in mv
 if (efb_getauthorisation.pmemberfunction_==NULL)
  efb_getauthorisation.init("getauthorisation","exodusprogrambasecreatedelete_",mv);
