...
var operator() (in inputfilename, io encoding1, io encoding2, out result, out msg)
{
 ...
 typedef var (ExodusProgramBase::*pExodusProgramBaseMemberFunction)(in,io,io,out,out);
 ...
 ((pExodusProgramBaseMemberFunction) (this->pmemberfunction_)))
  (inputfilename,encoding1,encoding2,result,msg);
