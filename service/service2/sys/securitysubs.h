//generated by exodus "compile ../sys/securitysubs"
//#ifndef EXODUSDLFUNC_SECURITYSUBS_H
#define EXODUSDLFUNC_SECURITYSUBS_H

//a member variable/object to cache a pointer/object for the shared library function
//ExodusFunctorBase efb_securitysubs;
class efb_securitysubs : private ExodusFunctorBase
{
public:

efb_securitysubs(MvEnvironment& mv) : ExodusFunctorBase("securitysubs", "exodusprogrambasecreatedelete_", mv) {}

efb_securitysubs& operator=(const var& newlibraryname) {
        closelib();
...
efb_securitysubs securitysubs{mv};
//#endif
