...
var inputbox(in msg, in maxlen, in show, in allowablechars, io data, in escx)
{

 //first time link to the shared lib and create/cache an object from it
 //passing current standard variables in mv
 if (efb_inputbox.pmemberfunction_==NULL)
  efb_inputbox.init("inputbox","exodusprogrambasecreatedelete_",mv);
