...
function main() {
	...
	var datasetcode = system.system.a(17);
	...
	var useremail = USERNAME.xlate("USERS".lcase(7, "X"));
	...
	if (USERNAME == "NEOSYS" or (system.system.a(17)).substr(-4, 4) == "TEST") {
	...
	body.r(-1, msg);
	body ^= FM;
	body.r(-1, "Server=" ^ system.system.a(44).trim());
	body.r(-1, "Install=" ^ var().osdir());
	if (ver.osread("general\\version.dat")) {
		body.r(-1, "Version=" ^ ver.a(1));
	}
	body.r(-1, "Database=" ^ system.system.a(45).trim() ^ " " ^ system.system.a(17));
	body.r(-1, "Process=" ^ system.system.a(24));
