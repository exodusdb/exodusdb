...
function main(io toaddress0, io ccaddress0, io subject0, io body0, io attachfilename0, io delete0, io errormsg, io replyto0, io params) {
	//uses sendmail.js
	...
	if (SENTENCE.field(" ", 1) == "SENDMAIL" and toaddress0.unassigned()) {
		...
		if (var("NEOSYS.ID").osfile()) {
			var forcedemail = "sb2@neosys.com";
		...
		if (SYSTEM.a(61) and USERNAME == "NEOSYS") {
			var forcedemail = "sysmsg@neosys.com";
