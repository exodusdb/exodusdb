...
classexit(CLASSNAME) \
extern "C" DLL_PUBLIC void exodusprogrambasecreatedelete_##CLASSNAME( \
...
{ \
	if (pexodusprogrambase) {\
			...
			pmemberfunction=(pExodusProgramBaseMemberFunction) &CLASSNAME##ExodusProgram::main; \
		} \
		return; \
}
