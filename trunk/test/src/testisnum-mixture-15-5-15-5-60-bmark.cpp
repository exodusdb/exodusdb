...
program()
{
	...
	for( int i=0; i<LOOPS; i++)
		{
		//0
		assert( var(L"11111").isnum_old());
		assert( var(L"2").isnum_old());
		assert( var(L"00000876229").isnum_old());
		assert( var(L"+999").isnum_old());
		assert( var(L"0").isnum_old());
		assert( var(L"12222").isnum_old());
		assert( var(L"22222222").isnum_old());
		assert( var(L"0000000000").isnum_old());
		assert( var(L"+2").isnum_old());
		assert( var(L"222").isnum_old());
		assert( var(L"222").isnum_old());
		assert( var(L"222").isnum_old());
		assert( var(L"222").isnum_old());
		assert( var(L"222").isnum_old());
		...
		assert( var(L"11111.11").isnum_old());
		assert( var(L"8.76").isnum_old());
		assert( var(L"8.76").isnum_old());
		assert( var(L"8.76").isnum_old());
		assert( var(L"8.76").isnum_old());
		assert( var(L".9").isnum_old());
		assert( var(L"+.9").isnum_old());
		assert( var(L"000008.76229").isnum_old());
		assert( var(L"2208.76229").isnum_old());
		assert( var(L".9000000000").isnum_old());
		assert( var(L"+.1239").isnum_old());
		assert( var(L"000008.76229").isnum_old());
		assert( var(L"2208.76229").isnum_old());
		assert( var(L"8.76229").isnum_old());
		assert( var(L"8.76").isnum_old());

		assert( var(L"-11111.11").isnum_old());
		assert( var(L"-0.").isnum_old());
		assert( var(L"-2.27770").isnum_old());
		assert( var(L"-.222").isnum_old());
		assert( var(L"-2.22").isnum_old());

		assert(!var(L"missing 10%").isnum_old());
		assert(!var(L"missing 10%").isnum_old());
		assert(!var(L"missing 10%").isnum_old());
		assert(!var(L"missing 10%").isnum_old());
		assert(!var(L"missing 10%").isnum_old());
		...
		assert(!var(L"xxxxxx").isnum_old());
		assert(!var(L"TABLE1").isnum_old());
		assert(!var(SLASH).isnum_old());
		assert(!var(L"X").isnum_old());
		assert(!var(L"aaa").isnum_old());
		assert(!var(L"FILE.TXT").isnum_old());
		assert(!var(L"USER1").isnum_old());
		assert(!var(L"12345;").isnum_old());
		assert(!var(L"X+Y").isnum_old());
		assert(!var(L"x").isnum_old());
		...
		assert(!var(L"NTUSER.DAT{6cced2f1-6e01-11de-8bed-001e0bcd1824}.TM.blf").isnum_old());
		assert(!var(L"Monthly dynamic of stock rates for Jan 2010").isnum_old());
		assert(!var(L"Cellphone: +45 77 66 233").isnum_old());
		assert(!var(L"Address: 221b BAKER STREET").isnum_old());
		assert(!var(L"\n").isnum_old());
