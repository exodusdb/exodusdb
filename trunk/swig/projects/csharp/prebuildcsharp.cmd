...
%SWIG32%\swig.exe -c++ -csharp -module %EXO_CSHARP_MODULENAME% -outdir "%EXO_CSHARP32_MODULEDIR%\%EXO_CSHARP_PACKAGE_SUBDIR%" -dllimport %EXO_CSHARP_WRAPPER_NAME% -I..\..\..\exodus\exodus -outcurrentdir %EXO_SWIG_OPTIONS% ..\..\exodus.i
