...
# 1. Locate std.cppm. path can vary a little — check with find or tab completion)
# Common locations in 2025–2026:
#   /usr/lib/llvm-$CLANG_VER/share/libc++/v1/std.cppm
#   /usr/share/libc++/v1/std.cppm

	STD_CPPM="/usr/lib/llvm-$CLANG_VER/share/libc++/v1/std.cppm"
