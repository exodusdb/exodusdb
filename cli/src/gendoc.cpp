...
function main() {
	...
	for (let osfilename : COMMAND.remove(1)) {
		...
		// Start a file for the code
		////////////////////////////

		let code_filename = replace("gendoc.{orig}.cpp", "{orig}", osfilename0);
//		std::ofstream codefile(code_filename.toString(), std::ios::binary);
		std::ofstream codefile(code_filename.toString());
