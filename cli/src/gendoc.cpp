		...
		for (var srcline : src) {
			...
			if (table_title) {
				...
				if (man) {
					...
					doc_outputl("");
					doc_outputl("{|class=\"wikitable\"");
					doc_outputl("!Usage!!Function!!Description");
				} else {
					...
					doc_outputl("<h", level, " id=", table_id, ">", short_title, "</h", level, ">");
					doc_outputl("");
//					// Using tailwind css classes
//					doc_outputl("<table class=\"table table-bordered table-sm\">");
					doc_outputl("<table class=wikitable>");
					doc_outputl("<tr> <th>Usage</th> <th>Function</th> <th>Description</th> </tr>");
				}
				continue;
			}
...
////////////////////////////////////
// Streams c++ code out to an osfile
////////////////////////////////////
...
//////////////////////////////////////////////////
// Accumulates all doc output into one long string
// ready for inserting content links when done.
//////////////////////////////////////////////////
