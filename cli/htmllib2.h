...
//#ifndef EXODUS_CALLABLE_HTMLLIB2_H
...
var operator() (in mode, io dataio, in params0 = "", in params20 = "", in glang = "")
{
 ...
 // Define a function type (htmllib2_pExoProgram_MemberFunc)
 // that can call the shared library object member function
 // with the right arguments and returning a var or void
 using htmllib2_pExoProgram_MemberFunc = auto (ExoProgram::*)(in,io,in,in,in) -> var;
 ...
 (reinterpret_cast<htmllib2_pExoProgram_MemberFunc>(this->pmemberfunc_)))
