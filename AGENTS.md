...
- **Unbound modal Cancel / Esc / close:** always assume discard if dirty — no “Discard data or instructions entered?”. Bound dialogs still confirm. Unlock still runs when locked (`gKeyNodes`).
