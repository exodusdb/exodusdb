...
function colors_val_screenfont() {
    ...
    neosys_set_style('screenfont', gvalue, gds.getx('SCREEN_FONT_SIZE'))
    return true
}

function colors_val_screenfontsize() {
    neosys_set_style('screenfont', gds.getx('SCREEN_FONT'), gvalue)
    return true
}
...
function neosys_dict_colorfontsize(dict, fn) {
    ...
    di.nwords = 1
    neosys_dict_color(di)
    di.validation = 'colors_val_screencolor()'
    ...
    di.nwords = 1
    neosys_dict_font(di)
    di.validation = 'colors_val_screenfont()'
    //di.required=true
    ...
    di.wordno = 7
    di.nwords = 1
    di.validation = 'colors_val_screenfontsize()'
    //di.defaultvalue='100'
